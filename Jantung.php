...
<body>
    ...
    <!-- home section start -->
    <section class="home" id="home" style="background-image: url(images/heart.jpg);">
        <div class="max-width">
            <div class="home-content">
                <div class="text-1">Cek</div>
                <div class="text-2">Kesehatan Jantung</div>
    ...
    <section class="services">
        <div class="max-width">
            <h2 class="title">Test Gejala Awal Penyakit Jantung</h2>
            </div>
    <!--BMI Calculator-->
        <div class="container">
            ...
            <label for="q1">Apakah Anda pernah merokok?</label><br>
            ...
            <label for="q2">Apakah Anda rutin berolahraga?</label><br>
            ...
            <label for="q3">Apakah Anda mengalami sesak napas atau sakit dada?</label><br>
            ...
            <label for="q4">Apakah Anda mengalami tekanan darah tinggi?</label><br>
            ...
            <label for="q5">Apakah Anda mengalami diabetes?</label><br>
		...
		if ($_SERVER["REQUEST_METHOD"] == "POST") {
			...
			if ($total_score >= 3) {
				...
				echo "<p>Anda perlu melakukan pemeriksaan kesehatan jantung lebih lanjut.</p>";
			} else {
                echo '<div class="result-box">';
				echo "<p>Kesehatan jantung Anda baik.</p>";
			}
		}
	?>
        </div>
